...
class ZoneModel extends Zzone {
  ZoneModel({required super.id, required super.name, required super.coordinates});

  factory ZoneModel.fromJson(Map<String, dynamic> json) {
    return ZoneModel(id: const Uuid().v4(), name: json['name'], coordinates: (json['coordinates'] as List).map((coord) => CoordinateModel.fromJson(coord)).toList());
  }
